...
exports.processGeminiRequest = void 0;
...
function processGeminiRequest(input) {
      ...
      `;
        try {
            ...
            const result = yield Promise.race([
                ...
                new Promise((_, reject) => setTimeout(() => reject(new Error("Timeout esperando respuesta")), 20000)),
            ]);
            ...
            const parsedResponse = JSON.parse(cleanTextResponse);
...
exports.processGeminiRequest = processGeminiRequest;
